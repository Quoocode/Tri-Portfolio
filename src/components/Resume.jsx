    ...
    <section className="band alt" id="resume">
      ...
      <div className="wrap">
        ...
        <div className="board callout reveal">
          ...
          <p>
            An IELTS <b>8.0</b>—but the road there wasn't a standard and linear climb.
            After hitting 7.0 in grade 10, I completely walked away from IELTS, leaving
            my English untouched until grade 12 demanded a retake for RMIT. With zero
            practice in between, I locked in for an intense, two-week sprint to secure a
            7.5, then immediately pushed the system further to cross the 8.0 finish line.
            I treated the exam like a systems problem, not a vocab grind: hunting down my
            own marginal errors, dissecting synonym traps, and sharpening spontaneous
            thinking under time pressure. That loop—analyse the gap, fix it fast—is how I
            approach everything.
          </p>
        </div>
        ...
        <ul className="bullets reveal">
          <li>
            <b>VNUHCM - High School for the Gifted (PTNK)</b>, Interdisciplinary
            Mathematics track <span className="yr">2023–26</span>
          </li>

          <li>
            <b>Valedictorian</b> - PTNK entrance exam, top score among 100 candidates
            from Bình Thọ Secondary <span className="yr">2023</span>
          </li>

          <li>
            <b>IELTS 8.0</b> - achieved after a continuous 2-week lock-in{' '}
            <span className="yr">2026</span>
          </li>

          <li>
            <b>Bronze Medal</b> - The April 30th Olympic Competition (English){' '}
            <span className="yr">2021</span>
          </li>

          <li>
            <b>Advanced Mathematics Program Student</b> - Thủ Đức City Level{' '}
            <span className="yr">2022–23</span>
          </li>

          <li>
            <b>Third Prize</b> - Thủ Đức City Math Contest{' '}
            <span className="yr">2022</span>
          </li>

          <li>
            <b>Second Prize</b> - Book Presentation Contest, as a 6th-grader in the
            9th-grade division <span className="yr">2020</span>
          </li>
        </ul>
